  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "auctionHouse"; isMut: true; isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "authority"; isMut: false; isSigner: true },
        { name: "newAuthority"; isMut: false; isSigner: false },
        {
          name: "feeWithdrawalDestination";
          isMut: true;
          isSigner: false;
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "auctionHouseFeeAccount"; isMut: true; isSigner: false },
        { name: "sellerTradeState"; isMut: true; isSigner: false },
        { name: "freeSellerTradeState"; isMut: true; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "programAsSigner"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false }
    ...
    },
    {
      ...
      accounts: [
        { name: "purchaseReceipt"; isMut: true; isSigner: false },
        { name: "listingReceipt"; isMut: true; isSigner: false },
        { name: "bidReceipt"; isMut: true; isSigner: false },
        { name: "bookkeeper"; isMut: true; isSigner: true },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false },
        { name: "instruction"; isMut: false; isSigner: false }
      ];
      args: [{ name: "purchaseReceiptBump"; type: "u8" }];
    }
  ];
  accounts: [
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "tradeState"; type: "publicKey" },
          { name: "bookkeeper"; type: "publicKey" },
          { name: "auctionHouse"; type: "publicKey" },
          { name: "buyer"; type: "publicKey" },
          { name: "metadata"; type: "publicKey" },
          { name: "tokenAccount"; type: { option: "publicKey" } },
          { name: "purchaseReceipt"; type: { option: "publicKey" } },
          { name: "price"; type: "u64" },
          { name: "tokenSize"; type: "u64" },
          { name: "bump"; type: "u8" },
          { name: "tradeStateBump"; type: "u8" },
          { name: "createdAt"; type: "i64" },
          { name: "canceledAt"; type: { option: "i64" } }
        ];
      };
    },
    {
  ...
  types: [
    {
      ...
      type: {
        kind: "enum";
        variants: [{ name: "PublicSale" }, { name: "PrivateSale" }];
      };
    }
  ];
  errors: [
    ...
    { code: 6003; name: "IncorrectOwner"; msg: "IncorrectOwner" },
    {
      code: 6004;
      name: "PublicKeysShouldBeUnique";
      msg: "PublicKeysShouldBeUnique";
    },
    { code: 6005; name: "StatementFalse"; msg: "StatementFalse" },
    { code: 6006; name: "NotRentExempt"; msg: "NotRentExempt" },
    { code: 6007; name: "NumericalOverflow"; msg: "NumericalOverflow" },
    {
      code: 6008;
    ...
    { code: 6013; name: "DerivedKeyInvalid"; msg: "Derived key invalid" },
    {
      code: 6014;
    ...
    { code: 6026; name: "ReceiptIsEmpty"; msg: "The receipt is empty" },
    {
      code: 6027;
